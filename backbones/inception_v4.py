...
#            'single_task', 'SingleTask', 'multi_task_length', 'MultiTaskLength',
#            'multi_task_design', 'MultiTaskDesgin']
...
class SingleTask1(nn.Module):

    def __init__(self, num_classes):
        super(SingleTask1, self).__init__()
        # Special attributs
...
def inception_v4(num_classes, pretrained='imagenet'):
    if pretrained:
